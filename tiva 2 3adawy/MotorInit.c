	...
	void ADCE_Init() // ADC init E4 PWM M5 E5 PWM M6
{
   ...
   //RCGCGPIO |= 0x10;                          // activate clock for Port E
	...
	// already written at ADC 8 pins function
	
	GPIODEN_PORTE   |= 0x30;                   // digital enable for 4,5
     
	/* it was wrong GPIODEN_PORTE   |= 0x3F;            digital enable for 0,1,4,5   */
...
*/    
 ADCSSCTL1_ADC0 |= 0x0064;      // (0x6) for ending squence and enable interrupt , (0x4) enable interrupt only 
