////////////////////////////////////////////////
/*
This file Has both tivas initializations 

Tiva 1:
       - Lifters (With encoders) (Two IR sensors were intended to be used)
			 - Loading and Serving mechanism (With object detection Sensor)
			 
Tiva 2:
       - Base motion (With 8 channel line follower using ADC)(two object detection sensors)(extra line sensor for vertical lines)
			 
File Includes:
         -Seperate Ports functions 
				 -Delay functions
				 -PWM Write function (analogWrite)
				 -Digital Write functions
				 -Digital Read Functions
				 -Stop Functions
				 
There are multiple of commented initializations used for trial purposes
