...
{  if (*(ADC)>1680 && *(ADC)<1800)
    ls1=1;
   else
    ls1=0;

 if (*(ADC+1)>1680 && *(ADC+1)<1800)
      ls2=1;
   else
       ls2=0;
 if (*(ADC+2)>1600 && *(ADC+2)<1800)
    ls3=1;
   else
    ls3=0;
  if (*(ADC+3)>1250 && *(ADC+3)<1500)
    ls4=1;
   else
   ls4=0;
 if (*(ADC+4)>1590 && *(ADC+4)<1800)
    ls5=1;
   else
   ls5=0;
 if (*(ADC+5)>1200 && *(ADC+5)<1400)
    ls6=1;
   else
   ls6=0;
 if (*(ADC+6)>1500 && *(ADC+6)<1650)
    ls7=1;
   else
   ls7=0;
 if (*(ADC+7)>1580 && *(ADC+7)<1780)
    ls8=1;
   else
   ls8=0;
    }
